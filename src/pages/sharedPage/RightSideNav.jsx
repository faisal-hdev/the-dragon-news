...
import learnMoreImg from "../../assets/bg.png";
  ...
  return (
    <div className="space-y-4 md:space-y-8 ">
      <div>
        ...
        <div className="space-y-4 my-2 rounded">
          <div className="hover:border-blue-500 hover:text-blue-500 duration-200 flex items-center text-center cursor-pointer justify-center gap-2 border-2 p-2 border-black rounded">
            <BsGoogle />
            <h3 className="font-semibold">Log in with Google</h3>
          </div>
          <div className="hover:border-blue-500 hover:text-blue-500 duration-200 flex items-center text-center cursor-pointer justify-center gap-2 border-2 p-2 border-black rounded">
            <FaGithub />
            <h3 className="font-semibold">Log in with Github</h3>
          </div>
        </div>
      </div>
      <div>
        <h3 className="text-lg font-semibold">Find Us On</h3>
        <div className="space-y-6 my-2 rounded">
          <div className="flex items-center gap-2 border-b pb-3 border-black rounded">
            {/* <svg
      ...
      <div>
        ...
        <div className="flex flex-col bg-[#F3F3F3] p-4 gap-6 rounded">
          <img src={qImg1} alt="" />
          <img src={qImg2} alt="" />
          <img src={qImg3} alt="" />
        </div>
      ...
      <div className="p-4 flex flex-col items-center relative ">
        <div className="flex flex-col items-center z-10 space-y-4 mt-12 text-white">
          <h3 className="w-full text-3xl font-semibold text-center lg:w-[190px]">
        ...
        <img
          src={learnMoreImg}
          className="rounded absolute -z-40 lg:h-[430px] w-full h-full lg:w-[272px] left-0"
          alt=""
        />
      </div>
    </div>
